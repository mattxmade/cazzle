...
const PropertyForm = (props: PropertyFormProps) => {
  ...
  return (
    <Stack gap={2}>
      ...
      <FormCard>
        <FormSection heading="Value" Icon={<CalculateIcon color="primary" />}>
          <MultilineTextField
            id="fullMarketPrice"
          ...
          <MultilineTextField
            ...
            defaultValue={
              propertyData.depositValue
                ? formatPrice(propertyData.depositValue, "GBP", undefined, true)
                : ""
            }
            textFieldProps={{
              InputProps: {
      ...
      <FormCard>
        <FormSection heading="Details" Icon={<HomeIcon color="primary" />}>
          <SelectDropdown
            id="propertyType"
            label="Property type"
